 ...
 * 先订单后重量
 */
public class WebSocketServerHandler2_dingdanhao7 extends ChannelHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (group.size() > 0) {
            for (int i = 0; i < list.size(); i++) {
                ...
                //System.out.println("3:"+group.find(list.get(i)));
                // System.out.println("4:"+group.find(list.get(i)).toString());
            }
            //LocalDateTime
            ...
            if (a_state > 0) {
                if (inputStr != null) {
                    ...
                    if (a_state > 0) {
                        ...
                        System.out.println("inputStr:" + inputStr);
                        //重量
                        String weight = inputStr.substring(2);
                        //识别符
                        String str = inputStr.substring(0, 2);
                        System.out.println(str);
                        if (str.equals("mg")) {
                            System.out.println("重量");
                            for (int i = 0; i < lists.size(); i++) {
                                inputStr = lists.get(i);
                            }
                            System.out.println("item1:" + inputStr);
                            lists.remove(inputStr);
                            System.out.println("item2:" + inputStr);
                            if (!inputStr.equals("customer") && !inputStr.equals("barcode")) {
                                    ...
                                    for (int i = 0; i < split.length; i++) {
                                        ...
                                        if (sortingByOidByBarcode != null) {
                                            ...
                                            if (barcodeByOidByBarcode != null) {
                                                ...
                                                System.out.println("1:" + echoContent.isEmpty());
                                                System.out.println("2:" + !echoContent.isEmpty());
                                                //判断此订单是否存在端口号
                                                if (!echoContent.isEmpty()) {
                                                    ...
                                                    //修改物品表的重量
                                                    int updateBarcodeByWeight = SortingController.barcodeService2.updateBarcodeByWeight(Double.valueOf(weight), inputStr, split[i]);
                                                    System.out.println("修改物品表:"+updateBarcodeByWeight);
                                                    //修改详细表
                                                    ...
                                                    sorting.setS_weight(Double.valueOf(weight));
                                                    System.out.println("重量:"+Double.valueOf(weight));
                                                    ...
                                                    if (cursorsBybarcode != null) {
                                                        ...
                                                        if (number > count) {
                                                            ...
                                                            //重量
                                                            cursors.setC_weight(Double.valueOf(weight));
                                                            System.out.println("重量:" + Double.valueOf(weight));
                                                        ...
                                                        cursors.setC_weight(Double.valueOf(weight));
                                                        System.out.println("物品重量:" + Double.valueOf(weight));
                                                        cursors.setC_time(d);
                                ...
                                if (echoContent.equals("&00")) {
                                    ...
                                    if (isBean) {
                                        ...
                                        ng1.setN_date(d);
                                        ng1.setN_weight(Double.valueOf(weight));
                                        if (ng != null) {
