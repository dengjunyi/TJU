 ...
 * 没有重量
 */
public class WebSocketServerHandler2_dingdanhao8 extends ChannelHandlerAdapter {
        ...
        if (group.size() > 0) {
            ...
            if (a_state > 0) {
                if (inputStr != null) {
                    ...
                    String sub3 = inputStr.substring(3, 4);
                    ;
                                            ...
                                            try {
                                                ...
                                                if (!echoContent.isEmpty()) {
                                                    ...
                                                    if (sortingByOidByBarcode != null) {
                                                        ...
                                                        //重量
                                                        sorting.setS_weight(Double.parseDouble("0"));
                                                        //条码
                                                        sorting.setS_barcode(inputStr);
                                                        //客户名称
