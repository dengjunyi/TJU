...
public class WebSocketServerHandler22 extends ChannelHandlerAdapter {
        ...
        if (inputStr != null) {
            ...
            try {
                ...
                if (resultSet1.last()) {
                    ...
                    System.out.println("订单号:" + resultSet1.getString("o_id"));
                    ...
                    if (resultSet2.last()) {
                        ...
                        String sql4 = "SELECT * FROM cursors WHERE c_barcode=?";// 查询sql语句
                        preparedStatement4 = connection.prepareStatement(sql4);
                        preparedStatement4.setString(1, inputStr);
                        resultSet4 = preparedStatement4.executeQuery();
                        System.out.println("条形码是否在数据库中的临时表存在:" + resultSet1.last());
                        if (resultSet4.last()) {
                            System.out.println("临时表存在这条条形码的信息");
                            //如果存在则修改临时表中的分拣数量
                            //获取已分拣数量
                            ...
                            String sql5 = "UPDATE cursors SET c_number=? WHERE c_barcode=?";
                            ...
                            System.out.println("临时表没有这条条形码的信息");
                            ...
                            ps.setString(4, resultSet1.getString("b_number"));
                    ...
                    WebSocketServerHandler.channelGroup.writeAndFlush(new TextWebSocketFrame(inputStr));
                }
            } catch (Exception e) {
                e.printStackTrace();
            } finally {
