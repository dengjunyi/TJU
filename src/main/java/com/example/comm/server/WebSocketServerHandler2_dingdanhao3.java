...
public class WebSocketServerHandler2_dingdanhao3 extends ChannelHandlerAdapter {
    ...
    public void handlerAdded(ChannelHandlerContext ctx) throws Exception {
        ...
        System.out.println("1:"+ channel.id());
        //channel.id();
       // channel.writeAndFlush(new TextWebSocketFrame("ng"));
        System.out.println("");
        System.out.println("");
